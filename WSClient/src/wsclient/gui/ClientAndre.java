        ...
        this.executeAction.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                            switch(actions.getSelectedIndex()){
                                case 1:
                                    JOptionPane.showMessageDialog(null, ws.getWSAndrePort().ted(correntistBox.getText(),Double.parseDouble(balanceBox.getText())));
                                break;
                                
                                case 2:
                                    wsandre.ObjectC correntista = ws.getWSAndrePort().correntista(correntistBox.getText());
