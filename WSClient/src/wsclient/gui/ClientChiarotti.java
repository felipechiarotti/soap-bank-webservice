...
import wsbank.webservice.ObjectC;
import wsbank.webservice.WSChiarotti_Service;
/**
 *
 * @author chiarotti
 */
public class ClientChiarotti{
    private JFrame frame;
    JPanel mainPanel;
    private JButton executeAction;
    private JTextField correntistBox;
    private JTextField balanceBox;
    private WSChiarotti_Service ws;
    JComboBox<String> actions;
    
    public ClientChiarotti(){
        this.ws = new WSChiarotti_Service();
        ...
        this.executeAction.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                            switch(actions.getSelectedIndex()){
                                case 1:
                                    ws.getWSChiarottiPort().ted(correntistBox.getText(),Double.parseDouble(balanceBox.getText()));
                                break;
                                
                                case 2:
                                    ObjectC correntista = ws.getWSChiarottiPort().correntista(correntistBox.getText());
