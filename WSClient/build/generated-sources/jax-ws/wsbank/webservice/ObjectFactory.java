 ...
 * generated in the wsbank.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Correntista_QNAME = new QName("http://webservice.wsbank/", "correntista");
    private final static QName _Ted_QNAME = new QName("http://webservice.wsbank/", "ted");
    private final static QName _TedResponse_QNAME = new QName("http://webservice.wsbank/", "tedResponse");
    private final static QName _CorrentistaResponse_QNAME = new QName("http://webservice.wsbank/", "correntistaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wsbank.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsbank/", name = "correntista")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsbank/", name = "ted")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsbank/", name = "tedResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsbank/", name = "correntistaResponse")
